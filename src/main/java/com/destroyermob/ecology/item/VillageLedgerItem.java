...
public class VillageLedgerItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        inspect(serverLevel, player, context.getClickedPos());
        return InteractionResult.CONSUME;
    }
    ...
    public static InteractionResult interactWithVillager(ItemStack stack, Player player, Villager villager) {
        ...
        if (player.isSecondaryUseActive()) {
            ...
            return VillageMarketStalls.clearAssignedStall(serverLevel, player, villager) ? InteractionResult.CONSUME : InteractionResult.PASS;
        }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        inspect(serverLevel, player, player.blockPosition());
        return InteractionResultHolder.consume(stack);
    }
    ...
    private static void inspect(ServerLevel level, Player player, BlockPos center) {
